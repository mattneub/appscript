...
- (id)initWithTargetType:(ASTargetType)targetType_ data:(id)targetData_ {
    ...
    appData = [[ASAppData alloc] initWithApplicationClass: [AEMApplication class]
                                            constantClass: [ICConstant class]
                                           referenceClass: [ICReference class]
...
- (ICReference *)AS_referenceWithObject:(id)object {
    if ([object isKindOfClass: [ICReference class]])
        return [[[ICReference alloc] initWithAppData: AS_appData
